...
public class DocGiaManage {
    ...
    public void updateData() {
        ...
        try {
            ...
            for (DocGia docGia : list) {
                String s = docGia.getDocGiaId() + "-" + docGia.getHoTen() + "-" + docGia.getSdt() + "-"
                        + docGia.getTaiKhoan() + "-" + docGia.getMatKhau() + "-" + docGia.getGioiTinh() + "-"
                        + docGia.getPhieuMuonId() + "\n";
    ...
    public void addData(String id, String ten, String sdt, String taikhoan, String matKhau, String gioiTinh,
            String phieuMuonId) {
        File file = new File(path);
        ...
        try {
            ...
            String s = id + "-" + ten + "-" + sdt + "-" + taikhoan + "-" + matKhau + "-" + gioiTinh + "-" + phieuMuonId
                    + "\n";
            byte[] buff = s.getBytes();
            out.write(buff);
            out.close();
