...
public class QuanLyDocGia extends BasePanel implements ModelTable.Listener<DocGia>, MouseListener {
    ...
    private static final String[] COLUMN_NAME = { "Mã đọc giả", "Tên đọc giả", "Số điện thoại", "Tài khoản",
            "Gioi tinh", "Mã phiếu mượn" };
    ...
    protected void handleClick(String name) {
        switch (name) {
        case BT_TIM_KIEM:
            docGiaMg.searchData(tf_id.getText(), tf_ten.getText(), tf_sdt.getText(), tf_tai_khoan.getText(),
                    tf_ma_phieu_muon.getText());
